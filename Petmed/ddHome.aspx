<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ddHome.aspx.cs" Inherits="Petmed.WebForm2" %>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        <div class="row align-items-center no-gutters">
                                            <div class="col me-2">
                                                <h6 class="mb-0"><strong>Fill Perscription A</strong></h6><span class="text-xs">10:30 AM</span>
                                            </div>
                                            <div class="col"><button class="btn btn-primary" type="button" style="margin-right: 0px;">Filled</button><button class="btn btn-primary" type="button" style="margin-right: -6px;">Print Shipping Label</button></div>
                                        </div>
                                    </li>
                                </ul>
                            </div>
