<%@ Page Title="" Language="C#" MasterPageFile="~/Site3.Master" AutoEventWireup="true" CodeBehind="home.aspx.cs" Inherits="Petmed.WebForm1" %>
            ...
            <div class="container">
                <div class="row mb-5">
                    <div class="col-md-8 col-xl-6 text-center mx-auto">
                        <h2 style="font-family: Lato, sans-serif;">Financial Business & Continuity Planning Portal</h2>
                        <p class="w-lg-50"></p>
                    </div>
                </div>
                        ...
                        <div class="card mb-5">
                            <div class="card-body d-flex flex-column align-items-center">
                                <form class="text-center" method="post">
                                    <div class="mb-3"><input class="form-control" type="email" name="email" placeholder="Accessnet Email"></div>
                                    ...
                                    <div class="mb-3"><button class="btn btn-primary d-block w-100" type="submit" style="color: var(--bs-card-bg);background: rgb(0,0,0);border-width: 0px;">Login</button><button class="btn btn-primary d-block w-100" type="submit" style="color: var(--bs-card-bg);background: rgb(0,0,0);border-width: 0px;">Forgot Password</button>
                                        ...
                                        <br />
                                        <a href="WebForm7.aspx">Go to admin landing</a>
                                        <br />
