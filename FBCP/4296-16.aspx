<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="4296-16.aspx.cs" Inherits="FBCP._4296_16" %>
...
<head runat="server">
    ...
    <title>4296-16</title>
    <link rel="stylesheet" href="4296-16-assets/css/bootstrap.min.css">
</head>
<body>
    ...
    <div style="padding: 1rem;">
        <div>
            <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item" role="presentation"><a class="nav-link active" role="tab" data-bs-toggle="tab" href="#tab-1">Due Dates</a></li>
                <li class="nav-item" role="presentation"><a class="nav-link" role="tab" data-bs-toggle="tab" href="#tab-2"><strong><span style="text-decoration: underline;">Validation Tables</span></strong></a></li>
            </ul>
    ...
    <script src="4296-16-assets/js/bootstrap.min.js"></script>
    </form>
</body>
</html>
