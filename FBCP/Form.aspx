...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="deptover">
        ...
        <div class="accordion mx-5" role="tablist" id="EntireFormContent">
            <div class="accordion-item" id="Import">
                ...
                <div class="accordion-item" id="DepartmentOverview">
                    <h1 class="accordion-header" role="tab">
                        <button class="accordion-button text-white bg-dark CategorySection" type="button" data-bs-toggle="collapse" data-bs-target="#EntireFormContent .item-1" aria-expanded="false" aria-controls="EntireFormContent .item-1">Department Overview</button></h1>
